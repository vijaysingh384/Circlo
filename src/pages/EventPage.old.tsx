...
export function EventPage() {
  ...
  const handleFileSelect = (
    ...
    if (!nameValidation.valid) {
      setError(nameValidation.error || 'Please enter your name first');
      return;
    }
    ...
    if (!filesValidation.valid) {
      setError(filesValidation.error || 'Invalid files');
      addToast(filesValidation.error || 'Invalid files', 'warning');
      return;
    }
